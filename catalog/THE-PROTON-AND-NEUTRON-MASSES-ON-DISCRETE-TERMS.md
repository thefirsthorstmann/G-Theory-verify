...
## 8 · The two residuals and the ratio 23/32
...
## 11 · The fine-structure side

The two grammars of Section 6 now do their work. The mass seats split arithmetically and store; the fine-structure seat splits at its midpoint and flows. The published reading of the run of nines as a borrow in flight [9] identifies the fine-structure residual as a current rather than a ledger, and this section treats it as one.
...
## 12 · The present epoch, and the drift
